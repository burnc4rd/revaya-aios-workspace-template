...
A decision worth keeping: a choice was made that could be questioned later, sets a pattern, or eliminates an alternative.
A learning worth keeping: something worked better than expected, something failed and revealed why, a pattern emerged that should be reused or avoided.
