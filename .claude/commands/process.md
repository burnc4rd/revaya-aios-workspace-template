...
This check is not about killing good ideas — it's about surfacing the OOBG lens so it becomes a habit.
To see the current OOBG: read `strategic-layer/oobg.md`.
