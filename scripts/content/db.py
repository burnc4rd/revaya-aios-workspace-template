...
Usage:
    python scripts/content/db.py              # Initialize or verify database
    python scripts/content/db.py --check      # Show table info and row counts
"""
...
CREATE TABLE IF NOT EXISTS content_ideas (
    ...
    edit_turnaround_days INTEGER,         -- days between filming/creating and publish
    ...
    airtable_record_id TEXT,              -- Airtable record ID (if synced)
...
-- If you have IntelOS with a meetings database, this table supplements it
-- with non-meeting content (LinkedIn posts, YouTube videos, etc.)
